...
namespace MvcMusicStore.Models
{
    public class SampleData : DropCreateDatabaseIfModelChanges<MusicStoreEntities>
    {
        protected override void Seed(MusicStoreEntities context)
        {
            ...
            new List<UserCredentialDetails>
            {
                new UserCredentialDetails {UserName = "swodesh",Password = "12345"},
                new UserCredentialDetails {UserName = "swodesh1",Password = "123"},
            }.ForEach(a => context.UserCredentialDetails.Add(a)); 
